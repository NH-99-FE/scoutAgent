// ============================================================
// Bash 输出流式累加器 — 增量追踪流式输出，有界内存
// 直接移植 Pi output-accumulator.ts，无 TUI 依赖
// ============================================================
...
/**
 * 增量追踪流式输出，有界内存。
 * 追加解码块使用流式 UTF-8 解码器，只保留解码后的尾段用于显示快照，
 * 当完整输出需要保留时打开临时文件。
 */
export class OutputAccumulator {
  ...
  constructor(options: OutputAccumulatorOptions = {}) {
    ...
    this.tempFilePrefix = options.tempFilePrefix ?? 'scout-bash';
  }
